...
export function IconLink({
  ...
  return (
    <Link
      {...props}
      className={cn(
        'hover:text-gray-70 group relative isolate flex items-center rounded-lg px-2 py-0.5 text-sm font-medium transition-colors dark:text-white/30 dark:hover:text-sky-300',
